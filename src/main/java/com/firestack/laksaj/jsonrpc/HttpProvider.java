...
public class HttpProvider {
    ...
    public double getDSBlockRate() throws IOException {
    ...
    public String getNumTxBlocks() throws IOException {
    ...
    public int getTransactionRate() throws IOException {
    ...
    public String getCurrentMiniEpoch() throws IOException {
