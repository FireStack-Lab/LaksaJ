...
public class ContractTest {
    ...
    public void deploy() throws Exception {
        ...
        DeployParams deployParams = DeployParams.builder().version(String.valueOf(pack(333, 2))).gasPrice("1000000000").gasLimit("1").senderPubKey("0246e7178dc8253201101e18fd6f6eb9972451d121fc57aa2a06dd5c111e58dc6a").build();
