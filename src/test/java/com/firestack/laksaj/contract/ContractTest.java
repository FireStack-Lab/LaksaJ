...
public class ContractTest {
    ...
    public void deploy() throws Exception {
        ...
        DeployParams deployParams = DeployParams.builder().version(String.valueOf(pack(333, 2))).gasPrice("1000000000").gasLimit("10000").senderPubKey("0246e7178dc8253201101e18fd6f6eb9972451d121fc57aa2a06dd5c111e58dc6a").build();
    ...
    public void call() throws Exception {
        ...
        wallet.addByPrivateKey("e19d05c5452598e24caad4a0d85a49146f7be089515c905ae6a19e8a578a6930");
        ContractFactory factory = ContractFactory.builder().provider(new HttpProvider("https://dev-api.zilliqa.com/")).signer(wallet).build();
        Contract contract = factory.atContract("zil1az5e0c6e4s4pazgahhmlca2cvgamp6kjtaxf4q", code, (Value[]) init.toArray(), "");
        CallParams params = CallParams.builder().version(String.valueOf(pack(333, 8))).gasPrice("1000000000").gasLimit("10000").senderPubKey("0246e7178dc8253201101e18fd6f6eb9972451d121fc57aa2a06dd5c111e58dc6a").amount("0").build();
