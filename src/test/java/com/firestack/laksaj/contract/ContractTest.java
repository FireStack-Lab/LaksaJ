...
public class ContractTest {
    ...
    public void deploy() {
       String code = "scilla_version 0\n" +
               ...
               "        event e\n" +
               "    end";
//        List<Value> init = Arrays.asList(Value.builder().vname("contractOwner").type("ByStr20").value("0x124567890124567890124567890124567890").build(), Value.builder().vname("name").type("String").value("NonFungibleToken").build(), Value.builder().vname("name").type("String").value("NFT").build());
