...
public class SchnorrTest {
    ...
    public void sign() {
        ...
        Signature signature = Schnorr.sign(ByteUtil.hexStringToByteArray(privateKey), ByteUtil.hexStringToByteArray(publicKey),
        ...
        Assert.assertEquals(signature.getS().toString(16).toUpperCase(),"E191EB14A70B5B53ADA45AFFF4A04578F5D8BB2B1C8A22985EA159B53826CDE7");
         ...
         signature = Schnorr.sign(ByteUtil.hexStringToByteArray(privateKey), ByteUtil.hexStringToByteArray(publicKey),
                ByteUtil.hexStringToByteArray(message),new BigInteger(k,16));
    ...
    @Test
    public void otherSigh() {
        String publicKey = "03F9A562AAD4BFF0A519D27DA65492ABB8CE68611A1B20B652E236153FCE3FE477";
        String privateKey = "4555E7274C051D0A7D651734A77C393F8F46E677CA09C51C6400B566437B8748";
        String message = "";
        String k = "CDA009EFDF0EF748DFCB0B369DE16B7B3291EA81619A13835A6BB267F4F6FB84";


        Signature signature = Schnorr.sign(ByteUtil.hexStringToByteArray(privateKey), ByteUtil.hexStringToByteArray(publicKey),
                ByteUtil.hexStringToByteArray(message), new BigInteger(k, 16));
        Assert.assertEquals(signature.getR().toString(16).toUpperCase(),"1D6C892D8459E7CD26716FF83879C76838414C4F754A2B18FA7AC1ED5E446821");
        Assert.assertEquals(signature.getS().toString(16).toUpperCase(),"43F7D3169425447E3786D82525F6B1AA10A072733C66340EC0280BAEAE5CAC9B");
